...
contract ZkSyncMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    function testZkOwnerCanExecuteCommands() public {
        ...
        Transaction memory transaction = _createUnsignedTransaction(
            ...
            113, // type 113 (0x71) for zkSync minimal account
            dest,
            value,
            functionData
        );
    ...
    function _createUnsignedTransaction(
        ...
        return Transaction({
            txType: transactionType, //type 113 (0x71) for zkSync minimal account
