...
contract ZkMinimalAccount is IAccount, Ownable {
    ...
    receive() external payable {
        // This contract is expected to receive ETH, so we implement a receive function.
        // It does not need to do anything, as the balance is checked in the validateTransaction function.
    }
